...
## respects the package.json sideEffects property for files in the root package and does not do deep side effects by default
...
## does not prefix the sideEffects property if the property starts with "./" even if deep side effects is set
