...
> Snapshot 1

    {
      ...
      function takeModule(withName) {␊
        return commonjsRequire(`./${withName}`, "/fixtures/function/dynamic-module-require");␊
      }␊
      ␊
      try {␊
...
> Snapshot 1

    {
      ...
      ␊
      function takeModule(withName) {␊
        return commonjsRequire(`./${withName}`, "/fixtures/function/dynamic-require");␊
      }␊
      ␊
      try {␊
        const submodule = takeModule('submodule');␊
...
> Snapshot 1

    {
      ...
      function takeModule(name) {␊
        return commonjsRequire(name, "/fixtures/function/dynamic-require-absolute-import/sub");␊
      }␊
      ␊
...
> Snapshot 1

    {
      ...
      for (const index of [1, 2]) {␊
        try {␊
          message = commonjsRequire(`./target${index}.js`, "/fixtures/function/dynamic-require-code-splitting");␊
        } catch (err) {␊
          ({ message } = err);␊
        }␊
      ...
      for (const index of [1, 2]) {␊
        try {␊
          message = lib2.commonjsRequire(`./target${index}.js`, "/fixtures/function/dynamic-require-code-splitting");␊
        } catch (err) {␊
          ({ message } = err);␊
        }␊
        t.is(message, index.toString());␊
...
> Snapshot 1

    {
      ...
      ␊
      function takeModule(withName) {␊
        return commonjsRequire(`./${withName}`, "/fixtures/function/dynamic-require-es-entry");␊
      }␊
      ␊
...
> Snapshot 1

    {
      ...
      ␊
      function takeModule(withName) {␊
        return commonjsRequire(`./${withName}`, "/fixtures/function/dynamic-require-extensions");␊
      }␊
      ␊
...
> Snapshot 1

    {
      ...
      ␊
      function takeModule(withName) {␊
        return commonjsRequire(`./${withName}`, "/fixtures/function/dynamic-require-globs");␊
      }␊
      ␊
...
> Snapshot 1

    {
      ...
      ␊
      function takeModule(withName) {␊
        return commonjsRequire(withName, "/fixtures/function/dynamic-require-instances");␊
      }␊
      ␊
...
> Snapshot 1

    {
      ...
      ␊
      function takeModule(withName) {␊
        return commonjsRequire(`./${withName}`, "/fixtures/function/dynamic-require-json");␊
      }␊
      ␊
...
> Snapshot 1

    {
      ...
      function takeModule$1(name) {␊
        return commonjsRequire(name, "/fixtures/function/dynamic-require-package/sub");␊
      }␊
      ␊
      var sub = {␊
        parent: takeModule$1('..'),␊
      ...
      ␊
      function takeModule(name) {␊
        return commonjsRequire(name, "/fixtures/function/dynamic-require-package");␊
      }␊
      ␊
...
> Snapshot 1

    {
      ...
      function takeModuleWithDelimiter(name, delimiter) {␊
        return commonjsRequire(`.${delimiter}${name.replace(/=/g, delimiter)}`, "/fixtures/function/dynamic-require-relative-paths");␊
      }␊
      ␊
...
> Snapshot 1

    {
      ...
      ␊
      function takeModule$1(name) {␊
        return commonjsRequire(name, "/fixtures/function/dynamic-require-resolve-index/sub");␊
      }␊
      ␊
      var sub = {␊
        parent: takeModule$1('..'),␊
      ...
      ␊
      function takeModule(name) {␊
        return commonjsRequire(name, "/fixtures/function/dynamic-require-resolve-index");␊
      }␊
      ␊
      t.is(takeModule('.'), 'same-directory');␊
      t.is(takeModule('./'), 'same-directory');␊
...
> Snapshot 1

    {
      ...
      function requireCustomModule () {␊
      	...
      	hasRequiredCustomModule = 1;␊
      	(function (module) {␊
      		module.exports = () => commonjsRequire.resolve('custom-module2',"/fixtures/function/dynamic-require-resolve-reference/node_modules/custom-module");␊
      } (customModule));␊
      ...
      function requireCustomModule2 () {␊
      	...
      	customModule2 = () => commonjsRequire.resolve('custom-module',"/fixtures/function/dynamic-require-resolve-reference/node_modules/custom-module2");␊
...
> Snapshot 1

    {
      ...
      ␊
      function takeModule$1(name) {␊
        return commonjsRequire(name, "/fixtures/function/dynamic-require-slash-access/sub");␊
      }␊
      ␊
      var sub = {␊
        parent: takeModule$1('..'),␊
      ...
      ␊
      function takeModule(name) {␊
        return commonjsRequire(name, "/fixtures/function/dynamic-require-slash-access");␊
      }␊
      ␊
      t.is(takeModule('.'), 'same-directory', '.');␊
      t.is(takeModule('./'), 'same-directory', './');␊
...
> Snapshot 1

    {
      ...
      ␊
      function takeModule(withName) {␊
        return commonjsRequire(withName, "/fixtures/function/dynamic-require-targets-fallback");␊
      }␊
      ␊
...
> Snapshot 1

    {
      ...
      ␊
      function takeModule(withName) {␊
        return commonjsRequire(withName, "/fixtures/function/dynamic-require-targets-no-fallback");␊
      }␊
      ␊
      t.is(takeModule('./dep1.js'), 'dep');␊
