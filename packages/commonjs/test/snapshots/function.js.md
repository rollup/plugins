...
> Snapshot 1

    {
      ...
      ␊
      var externalDefault = /*@__PURE__*/getAugmentedNamespace(externalEsmDefault);␊
      ␊
      t.deepEqual(externalExports, { foo: 'foo' }, 'external exports');␊
      t.deepEqual(externalModuleExports, 'bar', 'external module exports');␊
      t.deepEqual(externalNamed, { foo: 'foo' }, 'external named');␊
...
> Snapshot 1

    {
      ...
      ␊
      var externalNamed = /*@__PURE__*/getAugmentedNamespace(externalEsmNamed);␊
      ␊
      var externalMixed = /*@__PURE__*/getAugmentedNamespace(externalEsmMixed);␊
      ␊
      var externalDefault = /*@__PURE__*/getAugmentedNamespace(externalEsmDefault);␊
      ␊
      t.deepEqual(externalNamed, { foo: 'foo' }, 'external named');␊
