...
## named-imports-from-cjs-with-default
...
## named-imports-from-ejs-with-default
...
> Snapshot 1

    {
      ...
      ␊
      var require$$0$$named = (def !== undefined ? {␊
                    default: def,␊
                    ...foo,␊
                  } : foo);␊
      ␊
      const { a: a$1, b: b$1 } = require$$0$$named;␊
      ␊
      t.is(a$1, 1);␊
      t.is(b$1, 2);␊
      `,
