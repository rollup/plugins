...
> Snapshot 1

    {
      ...
      ␊
      var externalMixed = getDefaultExportFromNamespaceIfNotNamed(externalEsmMixed);␊
      ␊
      var externalDefault = getDefaultExportFromNamespaceIfNotNamed(externalEsmDefault);␊
      ␊
...
> Snapshot 1

    {
      ...
      ␊
      t.deepEqual(dep_false_default_$1, { default: 'default' }, 'false default');␊
      t.deepEqual(dep_false_mixed_$1, { default: 'default', named: 'named' }, 'false mixed');␊
      t.deepEqual(dep_false_named_, { named: 'named' }, 'false named');␊
      ␊
...
> Snapshot 1

    {
      ...
      ␊
      var externalNamed = getDefaultExportFromNamespaceIfPresent(externalEsmNamed);␊
      ␊
      var externalMixed = getDefaultExportFromNamespaceIfPresent(externalEsmMixed);␊
      ␊
      var externalDefault = getDefaultExportFromNamespaceIfPresent(externalEsmDefault);␊
      ␊
      t.deepEqual(named, { foo: 'foo' }, 'named exports');␊
...
> Snapshot 1

    {
      ...
      'entry.js': `'use strict';␊
      ␊
      var entry = require('./entry-becd84f0.js');␊
      ␊
      ␊
      ␊
...
> Snapshot 1

    {
      ...
      'entry.js': `'use strict';␊
      ␊
      var entry = require('./entry-2e56ab7c.js');␊
      ␊
      ␊
      ␊
      module.exports = entry.entry$1;␊
...
> Snapshot 1

    {
      ...
      'entry.js': `'use strict';␊
      ␊
      var entry = require('./entry-00c7c97c.js');␊
      ␊
      ␊
      ␊
      module.exports = entry.entry$1;␊
